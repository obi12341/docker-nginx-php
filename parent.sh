...
sed -i "s/session.save_handler = memcached/session.save_handler = ${PHP_SESSION_SAVE_HANDLER}/g" /etc/php/7.2/fpm/php.ini
sed -i "s#session.save_path = \"memcache:11211\"#session.save_path = \"${PHP_SESSION_SAVE_PATH}\"#g" /etc/php/7.2/fpm/php.ini
